...
uses
  ...
  uFireMetaController in 'Controller\uFireMetaController.pas',
  uMetadataColumn in 'Model\uMetadataColumn.pas',
  uMetadataConstraint in 'Model\uMetadataConstraint.pas',
  uMetadataIndex in 'Model\uMetadataIndex.pas',
  uFireMetaWebModule in 'uFireMetaWebModule.pas' {FireMetaWebModule: TWebModule},
  uMetadataTables in 'Model\uMetadataTables.pas';
...
begin
  ...
  try
    ...
    LServer.Active := True;
    WriteLn('Nomes das Tabelas: http://localhost:8080/metadata/tables');
